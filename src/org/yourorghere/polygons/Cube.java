...
import org.yourorghere.render.TextureManager;
...
public class Cube {
    ...
    public Cube(Point3d position, boolean withTextures) {
        this.position = position;
        
        if (withTextures) {
            textureFront = TextureManager.getTexture(TextureManager.IMAGE_STICKER_RED);
            textureBack = TextureManager.getTexture(TextureManager.IMAGE_STICKER_GREEN);
            textureLeft = TextureManager.getTexture(TextureManager.IMAGE_STICKER_BLUE);
            textureRight = TextureManager.getTexture(TextureManager.IMAGE_STICKER_YELLOW);
            textureTop = TextureManager.getTexture(TextureManager.IMAGE_STICKER_WHITE);
            textureBottom = TextureManager.getTexture(TextureManager.IMAGE_STICKER_ORANGE);
        }
    }
